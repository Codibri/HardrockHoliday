...
{
	// we have to use D3DXVECTOR4 here instead of other datatypes because the directx packs everything in 4 byte groups.
...
struct PARTICLE_SYSTEM_DATA
{
	...
	EParticleDistribution aParticleDistribution[1000];
	EState iLastState;
...
{
public:
	CParticleRenderer(CDirectX *pRenderAPI);
