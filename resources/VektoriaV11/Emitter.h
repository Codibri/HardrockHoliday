...
private:
	...
	void GetParticlesToSpawn(int iStartTime, int iEndTime, EParticleDistribution * vParticleDistribution, int * iArraySize, int * iParticleCount, int * iTimeOffset);
